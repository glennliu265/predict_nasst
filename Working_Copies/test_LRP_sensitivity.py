...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  2 11:35:45 2023
...
for bb in range(nbetas):
    ...
    for v in range(nvars):
        ...
        if calc_lrp:
            ...
            #     for sv in range(len(save_vars)):
            #         outname    = "%s%s/Metrics/Test_Metrics_%s_%s_evensample%i_%s.npy" % (datpath,expdir_new,dataset_name,varname,even_sample,save_vars_name[sv])
